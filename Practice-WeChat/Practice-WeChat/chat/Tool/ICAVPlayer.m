...
- (void)presentFromVideoView:(UIView *)fromView
    ...
    _toContainerView = toContainer == nil ? [[UIApplication sharedApplication].windows lastObject] : toContainer;
    
    _fromView = fromView;
    
    [_toContainerView addSubview:self];
    
    CGFloat height = fromView.frame.size.height * App_Frame_Width / fromView.frame.size.width;
